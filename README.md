...
Note: If you limit gem loading this way, make sure you are not using `config/initializers/asset_sync.rb`
or add a `if defined?(AssetSync)` around your initializer code.
